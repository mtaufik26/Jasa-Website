// components/ui/ButtonKonsul.jsx
...
function ButtonKonsul({
  ...
  // ✅ Sanitasi nomor WhatsApp (hapus spasi & karakter khusus)
  const sanitizedPhone = phone.replace(/[\s\-\+\(\)]/g, '');
  const whatsappLink = `https://wa.me/${sanitizedPhone}?text=${encodeURIComponent(message)}`;

  // ✅ Variasi button berdasarkan tema hitam-putih
  const baseStyles = `
  ...
  // ✅ Ikon WhatsApp yang lebih minimal
  const WhatsAppIcon = () => (
    <svg
  ...
  // ✅ Arrow icon untuk secondary variant
  const ArrowIcon = () => (
    <svg

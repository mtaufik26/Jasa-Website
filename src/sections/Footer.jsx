...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Facebook',
      href: 'https://facebook.com/batakreatif',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="mb-4">
                <h3 className="text-2xl font-bold text-gray-900">Bata Kreatif</h3>
                <p className="text-gray-500 mt-1">Jasa Pembuatan Website Profesional</p>
              </div>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Kami membantu bisnis Anda tumbuh dengan website yang profesional, modern, dan optimal. 
                Pengalaman bertahun-tahun dalam membuat berbagai jenis website untuk berbagai industri.
              </p>
